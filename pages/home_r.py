...
_welcome_txt = ft.Text(value="\nWalk Saver | Keeping track of your footprints\n",
                       size=30,
...
_open_maps = ft.Chip(
    label=ft.Text("Open Maps"),
    leading=ft.Icon(ft.icons.MAP_SHARP),
    on_click=lambda e: e.page.launch_url("https://google.com/maps"),
)
...
def create_home_view(page):
    ...
    view_home = ft.View(
        ...
        controls=[ft.Stack(
            [
                ft.Image(
                    src="C:/Projects/WalkingApp/WalkingApp/assets/Photos/Theme.png",
                ...
                ft.Container(content=ft.Text(f"{month_time // 60}:{month_time % 60:02}:00 hours." if month_time
                                             else "0 hours."),
                             top=450,
                             left=200,
                             margin=10,
                ...
                ft.Container(content=ft.Text(f"{month_kcal or 0} Kcal"),
                             ...
                             height=80,
                             bgcolor=ft.colors.BLUE_GREY_50),
                ft.Container(content=ft.Text(f"{month_steps or 0} steps"),
                             top=550,
                             left=200,
                             margin=10,
                             padding=10,
